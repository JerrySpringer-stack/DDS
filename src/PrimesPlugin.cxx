...
{
    try {
        PrimeNumberRequest *sample = new PrimeNumberRequest();
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        ...
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberRequest >::get().native()
        ,
        &programProperty,
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberRequest >::get().native()
        ;
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberRequest >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    PrimeNumberRequest, 
    true, true, true>();
...
{ 
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< PrimeNumberRequest >::get().native();
    #endif
    ...
    static const char * TYPE_NAME = "PrimeNumberRequest";
...
{
    try {
        PrimeNumberReply *sample = new PrimeNumberReply();
        ::rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
    ...
    RTICdrTypeCode *type_code)
{
    ...
    programs = DDS_TypeCodeFactory_assert_programs_in_global_list(
        DDS_TypeCodeFactory_get_instance(),
        (DDS_TypeCode *) (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberReply >::get().native()
        ,
        &programProperty,
        RTI_XCDR_PROGRAM_MASK_TYPEPLUGIN);
    ...
    ::dds::core::policy::DataRepresentationId representation)
{
    ...
    try{
        ...
        epd.programContext.endpointPluginData = &epd;
        plugin.typeCode = (struct RTICdrTypeCode *)
        (RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberReply >::get().native()
        ;
        pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
        PrimeNumberReply, 
        true, true, true>();
    ...
    unsigned int length)
{
    ...
    epd.programContext.endpointPluginData = &epd;
    plugin.typeCode = (struct RTICdrTypeCode *)
    (struct RTICdrTypeCode *)(RTIXCdrTypeCode *)&::rti::topic::dynamic_type< PrimeNumberReply >::get().native()
    ;
    pd.programs = ::rti::topic::interpreter::get_cdr_serialization_programs<
    PrimeNumberReply, 
    true, true, true>();
...
{ 
    ...
    */
    ...
    #else
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &::rti::topic::dynamic_type< PrimeNumberReply >::get().native();
    #endif
    plugin->languageKind = PRES_TYPEPLUGIN_CPPSTL_LANG;
    ...
    static const char * TYPE_NAME = "PrimeNumberReply";
    plugin->endpointTypeName = TYPE_NAME;
    plugin->isMetpType = RTI_FALSE;
    return plugin;
}

...
#ifndef Primes_831781195_hpp
#define Primes_831781195_hpp
...
class NDDSUSERDllExport PrimeNumberReply {
  public:
    ...
    PrimeNumberReply(
        const ::rti::core::bounded_sequence< int32_t, (PRIME_SEQUENCE_MAX_LENGTH) >& primes,
        const PrimeNumberCalculationStatus& status);
